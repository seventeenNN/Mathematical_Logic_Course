/***
 ***  generated by CSeq [ 0000 / 0000 ] 2024-12-19 17:22:30
 ***
 ...
 ***
 ***  params:
 ***    -l lazy -i examples/peterson.c --backend cbmc
 ***
 ***  modules:
 ***    7C56 workarounds ()
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[4] __cs_thread_lines[] = {4, 6, 8};
...
IF(0,0,tmain_1)
                                   ...
                                   pthread_create_2(& __cs_local_main_t1, 0, thr1_0, 0, 1);
                                   
tmain_1: IF(0,1,tmain_2)
                                   
                                   pthread_create_2(& __cs_local_main_t2, 0, thr2_0, 0, 2);
